...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $difficultyThemesSheet->sheet_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $difficultyThemesSheet->sheet_id)]
            )
        ?></li>
...
<div class="difficultyThemesSheets form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Difficulty Themes Sheet') ?></legend>
        <?php
